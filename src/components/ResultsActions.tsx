...
export function ResultsActions({ sessionId, coreAxes, topFlavor }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Share Section */}
      <ShareSection sessionId={sessionId} topFlavor={topFlavor} />
    </div>
  )
}

function ShareSection({ sessionId, topFlavor }: { sessionId: string; topFlavor: FlavorMatch | null }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 max-w-2xl mx-auto">
      <h3 className="text-lg font-semibold text-gray-800 mb-4 text-center">Share Your Results</h3>
      ...
      <div className="flex items-center gap-2 mb-4">
        <input
          ...
          value={shareUrl}
          readOnly
          className="flex-1 px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <button
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-4 py-2 bg-[#FF4500] hover:bg-[#e03d00] text-white rounded-lg font-medium transition-colors"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
